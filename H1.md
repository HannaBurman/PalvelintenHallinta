...
- Ohjeistus siitä, kuinka salt asennetaan, testataan ja kuinka sitä käytetään
- Tässä käsiteltävät moduulit ovat pkg, file, service, user ja cmd.
- pkg on moduuli pakettien hallintaan, ja mahdollistaa ohjelmistopakettien asennuksen, poistamisen ja päivittämisen
