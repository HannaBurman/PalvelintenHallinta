...
Seuraavaksi olisi tarkoitus lisätä mplayerin (YouTube klippiä varten), tekstitiedoston hengitysharjoitusta varten ja tyhjän päiväkirjan sls-tiedostoon seuraavalla komennolla

    $ sudo nano /srv/salt/relaxation/install_environment.sls

Nyt tulee tänkapå. Vaihtoehtona on vaihtaa suunnitelmaa ja tehdä jotain mitä on jo aiemmin tehty ja mistä ottaa mallia tai sitten Salt Projectin (2024) ja ChatGPT:n (2024) avulla rakentaa jotain uutta ja testailla. Valitsen toisen vaihtoehdon, sillä koen oppivani siinä enemmän. 


Sls-tiedostoon tulevat määritykset, jotka teen ensin käsin:
...
Hengitysharjoituksen tekstitiedosto on jo tehty masteriin, mutta teen sen käsin suoraan minioniin samalla tekstillä. 

    $ sudo nano /home/vagrant/breathing_exercises.txt


Sitten tunnepäiväkirja. Tämäkin suoraan minioniin. 

    $ sudo nano /home/vagrant/diary.txt
...
Sitten itse sls-tiedoston tekoon!
