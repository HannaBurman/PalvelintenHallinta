...
Aloitan koko projektin puhtaalta pöydältä ja tuhon kaiken vanhan. Aloitan avaamalla terminaalin ja luomalla projektille hakemiston. JOs haluat nähdä alkuvalmistelut, ne löytyvät täältä: [
](https://github.com/HannaBurman/PalvelintenHallinta/blob/main/H4.md)
