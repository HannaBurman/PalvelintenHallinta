...
- Skaalarit: Avain-arvo-parit, joissa arvo voi olla numero, merkkijono tai looginen arvo.
- Listat: Avain, jota seuraa lista arvoista. Jokainen arvo aloitetaan kahdella välilyönnillä ja yhdysmerkillä.
- Sanakirjat: Avain-arvo-parien ja listojen kokoelma.
