...
Lähteet: Karvinen 2021, Valkamo 2022.
...
Jatkoin 7.11.2024 klo 10.05 ja lopetin klo 
...
Eli seuraavalla komennolla latasin saltin julkisen GPG-avaimen ja tallensin sen tiedostoon /etc/apt/keyrings/salt-archive-keyring.pgp

    $ curl -fsSL https://packages.broadcom.com/artifactory/api/security/keypair/SaltProjectKey/public | sudo tee /etc/apt/keyrings/salt-archive-keyring.pgp


<img width="630" alt="Näyttökuva 2024-11-07 kello 12 09 40" src="https://github.com/user-attachments/assets/98209d89-88d7-4195-abc8-691dfe14fe3a">

Sitten lisään saltstackin ohjelmanlähteen

    $ echo "deb [signed-by=/etc/apt/keyrings/salt-archive-keyring.pgp] https://packages.broadcom.com/artifactory/saltproject-deb stable main" | sudo tee /etc/apt/sources.list.d/salt.sources

<img width="630" alt="Näyttökuva 2024-11-07 kello 12 11 03" src="https://github.com/user-attachments/assets/48a88e68-9f23-4545-af81-3d7b3b2905d2">
...
<img width="604" alt="Näyttökuva 2024-11-07 kello 10 38 36" src="https://github.com/user-attachments/assets/c3cf5131-6cd4-4209-b820-17f3f3638eff">


Noniin, ja sitten itse tehtävään. Tarkoituksena olisi siis luoda Herra-orja arkkitehtuuri tähän uuteen verkkoon ja demonstroida sitä. Asennan siis SSH1 koneelle salt-masterin ja SSH2 koneelle salt-minion. Laitan lisäksi orjan /etc/salt/minion -tiedostoon masterin osoitteen. Hyväksy avain ja osoita, että herra voi komentaa orjakonetta.

    $ sudo apt update

Jostain syystä herjas erroria. Googlailin ja tutkin ja tulin siihen lopputulokseen, että aika on väärä ja saattaa siksi herjata. 
    
<img width="591" alt="Näyttökuva 2024-11-07 kello 11 05 24" src="https://github.com/user-attachments/assets/03485ef7-6d82-4026-9811-5c8b08100c59">

Stack Overflow- keskustekupalstalta löytyi mahdollinen syy, joka voisi olla virtuaalikoneen väärä aika. Annoin komennot

    $ sudo timedatectl set-ntp true
    $ timedatectl

<img width="397" alt="Näyttökuva 2024-11-07 kello 11 17 11" src="https://github.com/user-attachments/assets/60ef2f63-eba6-4ed6-8c51-0e5d08398c4e">

Sitten vielä kellon asettaminen Europan aikaan ja ajan tarkistus. 

    $ sudo timedatectl set-timezone Europe/Helsinki
    $ timedatectl

<img width="400" alt="Näyttökuva 2024-11-07 kello 11 20 55" src="https://github.com/user-attachments/assets/8e2ad93c-9fe5-42d2-928b-04693885c4ea">
...
<img width="405" alt="Näyttökuva 2024-11-07 kello 10 56 20" src="https://github.com/user-attachments/assets/9969bad4-85d7-4943-a317-c4715d80dff9">


Lähteet: Karvinen 2023, Karvinen 2021, Salt projektin blogi 2024, Salt projektin salt install guide 2022-2024, Stack Overflow 2020. 
...
-  Salt projektin salt install guide 2022-2024. Luettavissa: https://docs.saltproject.io/salt/install-guide/en/latest/topics/install-by-operating-system/linux-deb.html#install-deb. Luettu 7.11.2024.
-  Stack Overflow 2020- keskustelupalsta. Luettavissa: ttps://stackoverflow.com/questions/33939834/how-to-correct-system-clock-in-vagrant-automatically. Luettu 7.11.2024. 
