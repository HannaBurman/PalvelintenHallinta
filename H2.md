...
Aloin tutkimaan lähemmin asiaa, sillä saltin palvelimet ovat käsittääkseni vain lyhyitä aikoja alhaalla. Löysin Salt projektin blogista lisätietoja, eli Salt Project on ilmoittanut, että bootstrap.saltproject.io -alaosoitteet poistuvat käytöstä vuoden 2024 loppuun mennessä. Tämä johtuu DNS-siirroista ja muista muutoksista, jotka vaikuttavat salt-bootstrap -skriptin lataamiseen. Tämän seurauksena nykyinen tapa ladata salt-bootstrap-skripti (esim. komento curl -L https://bootstrap.saltproject.io) ei enää toim.

Seuravaksi poistin kaiken saltiin liittyvän ja aloitin alusta komennolla:

    $ sudo apt-get remove --purge salt-master salt-minion salt-ssh salt-cloud salt-syndic
    $ sudo apt-get autoremove  


Ja sitten ladataan uudelleen komennolla: 

    $ curl -o bootstrap-salt.sh -L https://bootstrap.saltproject.io/bootstrap-salt.sh
    
<img width="723" alt="Näyttökuva 2024-11-05 kello 11 00 57" src="https://github.com/user-attachments/assets/fb90a550-000d-4349-ad4c-038080725496">

Päivitin saltin lähteet komennolla:

    $ sudo nano /etc/apt/sources.list.d/saltstack.list

<img width="723" alt="Näyttökuva 2024-11-05 kello 11 03 08" src="https://github.com/user-attachments/assets/85af7d8c-f12b-4a5c-933d-381231c97e64">

Ja lisäsin tänne uuden lähteen: deb https://bootstrap.saltproject.io/py3/debian/12/amd64/latest salt-py3 main ja tallennan.
...
<img width="723" alt="Näyttökuva 2024-11-05 kello 11 14 49" src="https://github.com/user-attachments/assets/5c976760-6f06-4386-b74b-c20f07801796">

    $ nslookup bootstrap.saltproject.io

DNS-haku osoitteelle bootstrap.saltproject.io on onnistunut ja se on nykyisin ohjattu saltstack.github.io -palvelimelle. Tämä tarkoittaa, että palvelimen DNS on siirretty, ja sen sijaan, että bootstrap.saltproject.io olisi itsenäinen palvelin, se on nyt osa GitHub Pagesia.

<img width="646" alt="Näyttökuva 2024-11-05 kello 11 53 26" src="https://github.com/user-attachments/assets/fcdeeab5-9dae-4326-9344-aab390093a6c">

     $ hostname -I   

<img width="562" alt="Näyttökuva 2024-11-05 kello 11 55 22" src="https://github.com/user-attachments/assets/b8f82bfa-2996-4f36-9c5e-55cc623d3036">

Tein uudelleen tulimuurille uudet säännöt komennoilla:

    $ sudo ufw allow 4505/tcp
    $ sudo ufw allow 4506/tcp

<img width="382" alt="Näyttökuva 2024-11-05 kello 11 57 29" src="https://github.com/user-attachments/assets/cc212c05-c0be-4e74-a29e-d6c822ea8289">
...
<img width="780" alt="Näyttökuva 2024-11-05 kello 12 02 40" src="https://github.com/user-attachments/assets/0f66f78d-daae-4923-80ec-9f960b37df3a">
...
Herjaa, ettei ole mitään "kandidaattia" virtualboxin asennukselle, joten kävin sen lataamassa sivuilta https://www.virtualbox.org/wiki/Downloads. 

<img width="390" alt="Näyttökuva 2024-11-05 kello 13 10 58" src="https://github.com/user-attachments/assets/3205d9e1-e8d8-4b5c-a656-4b398789c2b9">
...
- Salt projektin blogi 2024. Luettavissa: https://saltproject.io/blog/salt-bootstrap-breakage/. Viitattu: 5.11.2024.
