...
Näyttäisi siltä, että virtuaalikone on väärässä ajassa. Pienen googlettelun jälkeen löydän oikeat komennot tämän selvittämiseen. 



<img width="391" alt="Näyttökuva 2024-11-08 kello 13 46 44" src="https://github.com/user-attachments/assets/e7618733-8cb9-4cf2-bb5b-20cbcfd1005a">



Hello-tilan voi tsekata näin:
cat /tmp/hellureihanna
Apache-palvelu voit tsekata näin:
