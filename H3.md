...
Aloitin tehtävän 16.11.2024 klo 14.30-16.16 ja lopetin tehtävän klo 
...
- Uudempien systemd-versioiden kanssa käytetään systemd-run-komentoa estämään prosessien tappaminen Salt-minionin toimesta.
