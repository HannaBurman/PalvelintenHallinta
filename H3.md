...
# a) Apache easy mode. Asenna Apache, korvaa sen testisivu ja varmista, että demoni käynnistyy. Ensin käsin, vasta sitten automaattisesti. Kirjoita tila sls-tiedostoon, pkg-file-service. 

Aloitan tehtävän 18.11.2024 klo 16.00 ja lopetan tehtävän klo 
...
Aloitin tehtävän 19.11.2024 klo 10.25

En ole varma ymmärsinkö tehtävänannon oikein, mutta kokeillaan. Tehtävänanoossa mainitaan portin 22 jättäminen auki kun käyttää vagrantia, jolloin muistin, että en ole tainnut asentaa palomuuria, joten teen sen ulkomuistista komennolla
...
Tehtävänannossa on maininta portista 1234, joten avaan vielä sen komennolla 
...
Sitten haluan päästä muokkaamaan portteja conffitiedostoon, joten annan Karvisen (2018b) vinkkien mukaisesti komennon
...
En tiedä olisiko ollut tarpeen, mutta restarttasin ssh:n komennolla
...
- Karvinen, T. 2024a. H3 tehtävänannon vinkit. Luettavissa: https://terokarvinen.com/2024/configuration-management-2024-spring/. Luettu 18.11.2024. 
...
- Karvinen, T. 2018b. Apache User Homepages Automatically – Salt Package-File-Service Example. Luettavissa: https://terokarvinen.com/2018/apache-user-homepages-automatically-salt-package-file-service-example/. Luettu: 18.11.2024. 
